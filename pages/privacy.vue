        ...
        <div class="box">
            ...
            <div class="collapse">
                <el-collapse v-model="activeNames" @change="handleChange">
                    <el-collapse-item title="一、隱私權保護政策的適用範圍" name="1">
                        <div>
                            隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。
                        </div>
                    </el-collapse-item>
                    <el-collapse-item title="二、個人資料的蒐集、處理及利用方式" name="2">
                        <ul>
                            ...
                            <li>為提供精確的服務，我們會將收集的填答內容進行統計與分析，分析結果之統計數據或說明文字呈現，除供內部研究外，我們會視需要公佈統計數據及說明文字，但不涉及特定個人之資料。</li>
                        </ul>
                    </el-collapse-item>
                    ...
                    <el-collapse-item title="四、網站對外的相關連結" name="4">
                        <div>
                            本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。
                        </div>
                    </el-collapse-item>
                    <el-collapse-item title="五、與第三人共用個人資料之政策" name="5">
                        <div>
                            本網站絕不會提供、交換、出租或出售任何您的個人資料給其他個人、團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。
                            <div style="margin-top: 10px;">前項但書之情形包括不限於：</div>
                            <ul>
                                <li>經由您書面同意。</li>
                                <li>法律明文規定。</li>
                    ...
                    <el-collapse-item title="六、Cookie之使用" name="6">
                        為了提供您最佳的服務，<span class="red-text">本網站會在您的電腦中放置並取用我們的 Cookie，若您不願接受 Cookie 的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕 Cookie 的寫入，但可能會導致網站某些功能無法正常執行。</span>
                    </el-collapse-item>
                    <el-collapse-item title="七、隱私權保護政策之修正" name="7">
